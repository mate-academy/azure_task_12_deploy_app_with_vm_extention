...
$Params = @{
    ...
    Settings          = @{fileUris = @('https://raw.githubusercontent.com/OlehHavelia1994/azure_task_12_deploy_app_with_vm_extention/refs/heads/develop/install-app.sh'); commandToExecute = './install-app.sh'}
}
