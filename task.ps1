...
Set-AzVMExtension `
    ...
    -SettingString '{"fileUris":["https://raw.githubusercontent.com/kenu21/azure_task_12_deploy_app_with_vm_extention/extension/install-app.sh"],"commandToExecute":"bash install-app.sh"}' `
    -Location $location
