...
$settings = @{
    fileUris = @("https://raw.githubusercontent.com/Somewellich/azure_task_12_deploy_app_with_vm_extention/main/install-app.sh")
...
Set-AzVMExtension `
    ...
    -Location $location `
    -SettingString (ConvertTo-Json $settings)
