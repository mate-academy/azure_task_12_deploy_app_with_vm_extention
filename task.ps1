...
$Params = @{
    ...
    Settings          = @{fileUris = @('https://raw.githubusercontent.com/Kulibchenko/azure_task_12_deploy_app_with_vm_extention/develop/install-app.sh'); commandToExecute = './install-app.sh'}
}
