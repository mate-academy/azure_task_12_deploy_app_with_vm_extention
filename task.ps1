...
for ($i = 1; $i -le $vmCount; $i++){
  $vmName = "matebox$i"
  $networkSecurityGroupName = "defaultnsg$i"
  $publicIpAddressName = "linuxboxpip$i"
  $sshKeyName = "linuxboxsshkey$i"
  ...
  $Params = @{
        ...
        Settings          = @{
          fileUris = @('https://raw.githubusercontent.com/<your-gh-username>/azure_task_12_deploy_app_with_vm_extention/main/install-app.sh');
