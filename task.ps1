...
$Params = @{
    ...
    Settings          = @{fileUris = @('https://raw.githubusercontent.com/Dima-shima/azure_task_12_deploy_app_with_vm_extention/main/install-app.sh'); commandToExecute = 'bash install-app.sh'}
}
