...
mkdir /app 
# Clone the repository - make sure to update <your-github-username> with your actual GitHub username
git clone https://github.com/dimonalek/azure_task_12_deploy_app_with_vm_extention.git
